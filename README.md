...
| 投稿文 | **78本分**、`posts.csv` に作成済み（たたき台） |
| 投稿予定 | **2026年8月25日 〜 11月10日**（1日1本） |
| 投稿時刻 | 日本時間 **20:00** |
| 投稿先 | Threads **@hiromi.lifeplan**（同じアカウントセンターに削除予定の shu1_omatomepan があるので取り違え注意） |

漫画が連作（つながった物語）なので、**番号順に投稿する並び**にしてあります。

1. `1-1` 〜 `14-3`（42枚）… 資産家との出会いから始まる長編＋退職後のお金の話（8/25〜10/5）
2. `15-1` 〜 `26-3`（36枚）… 少し先を歩く人から学ぶ／借入の考え方／学びを人に返す（10/6〜11/10）
